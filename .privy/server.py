...
# --- TOOL 4: LangGraph Powered Workflow ---
...
def run_creative_flow(rough_idea: str) -> dict:

    """

    Takes a rough idea and runs it through an automated workflow:

    1. Optimizes the prompt.

    2. Generates an image from the optimized prompt.

    """

    # Create a new graph instance, passing the tools it needs

    graph = create_graph(

        optimizer_tool=optimize_image_prompt,

        generator_tool=generate_image
    ...
    initial_state = {"rough_idea": rough_idea}
